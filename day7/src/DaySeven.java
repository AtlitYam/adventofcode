...
public class DaySeven {
    public static void main(String[] args) {
        ...
        System.out.printf("The total size of all folders smaller than 100.000 is %s%n", DaySevenImpl.getTotalSizeOfFoldersSmallerThan(folders, files, (int) 1e5));

        // For the second challenge we need to find the smallest folder of at least 8.381.165
        System.out.printf("The smallest folder of at least 8.381.165 has a size of %s%n", DaySevenImpl.getFirstFolderOfAtleastSize(folders, files, requiredSpaceForUpdate));
